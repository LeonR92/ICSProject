...
class MailHandler:
    ...
    def create_ics_file(self, event_name: str, start_time: datetime, end_time: datetime, description: str, location: str, attendee_email: str) -> str:
...
END:VCALENDAR"""
    ...
    def send_email(self, smtp_conn: smtplib.SMTP, to_email: str, subject: str, body: str, attachment_path: str = None):
        ...
        if attachment_path:
            attachment = MIMEBase('text', 'calendar', method='REQUEST', name=os.path.basename(attachment_path))
